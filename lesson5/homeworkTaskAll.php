...
$connect_db = mysqli_connect("localhost", "root", "", "lesson_fifth");
...
<!-- В базе данных сделал три таблицы: 
 'media' - содержит id  и название картинки;  
 'images_mini' - содержит id сведения о месте расположения 
 маленьких картинок и ссылку на таблицу 'media';
 'images_big' - содержит id сведения о месте расположения 
 больших картинок, размер, количество просмотров и ссылку на таблицу 'media'; -->